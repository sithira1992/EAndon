...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2015 at 08:20 PM
...
(1, 2, 'Sand', '1000', '100asd', NULL, '1dasda', NULL),
(2, 3, 'Stone', '2', '2', '2', 'a', NULL),
(3, 4, 'Chip', '22', '11', '11', '1', ''),
(4, 1, 'a', '22', '11', '11', '1', ''),
(5, 1, 'we', '11', '11', '1', 'ss', '');
...
(3, 'ada', 'dasd', '0756895896', 'aaa@gmail.com', 'asfdas', 'asdas', 'dasd'),
(4, 'maheshudara', '222', '0716362465', 'mu@gmail.com', 'makaa', 'maa', 'jhhuhui'),
(6, 'aa', 'a', '0716279549', 'a@gmail.com', 'aa', '123', '1'),
(7, 'aaa', 'a', '0716479545', 'a@gmail.com', 'aa', '10000', '1');
...
CREATE TABLE IF NOT EXISTS `requestform` (
  ...
  `FK_SendTo` int(11) DEFAULT NULL,
  `SendToStatus` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `requestform` (`id`, `FK_Location`, `FK_ManagerName`, `Item`, `Unit`, `Quantity`, `Date`, `FK_SendTo`, `SendToStatus`) VALUES
(1, 5, 15, 'Bricks', 'Kg', '45', '2015-10-06', NULL, NULL),
(2, 5, 16, 'Sand', 'cube', '5', '2015-10-06', NULL, NULL),
(3, 5, 0, 'Cement', 'Bags', '11', '2015-10-04', NULL, NULL),
(4, 0, 16, 'Cement', 'cube', '45', '2015-10-04', NULL, NULL),
(5, 5, 16, 'Cement', 'cube', '45', '2015-10-04', NULL, NULL),
(6, 5, 14, 'Sand', 'cube', '2', '2015-10-04', NULL, NULL),
(7, 5, 15, 'Stone', 'cube', '3', '2015-10-04', NULL, NULL),
(8, 5, 16, 'Stone', 'cube', '5', '2015-10-04', NULL, NULL),
(12, 5, 22, '', 'cube', '5', '2015-07-26', NULL, NULL),
(13, 5, 22, '', 'cube', '5', '2015-07-26', NULL, NULL),
(14, 5, 22, 'Sand', 'cube', '5', '2015-07-26', 17, '1'),
(15, 5, 22, 'Sand', 'cube', '10', '2015-07-26', 16, '1'),
(16, 5, 22, 'Sand', 'cube', '45', '2015-07-26', 17, NULL),
(17, 5, 22, 'Sand', 'cube', '15', '2015-07-26', 17, NULL),
(18, 5, 22, 'Stone', 'cube', '10', '2015-07-26', 22, NULL),
(19, 5, 22, 'Stone', 'cube', '12', '2015-07-26', 22, NULL),
(20, 5, 22, 'Stone', 'cube', '12', '2015-07-26', 22, NULL),
(21, 5, 22, 'Sand', 'cube', '55', '2015-05-30', 22, NULL),
(22, 5, 22, 'Sand', 'cube', '55', '2015-05-30', 22, NULL),
(23, 5, 22, 'Sand', 'cube', '55', '2015-05-30', 22, NULL),
(24, 5, 22, 'Sand', 'cube', '10', '2015-05-30', 17, '1'),
(25, 5, 22, 'Chip', 'cube', '2', '2015-05-30', 20, '1'),
(26, 5, 17, 'Sand', 'cube', '2', '2015-07-27', 22, NULL),
(27, 5, 22, 'Chip', 'cube', '5', '2015-07-27', 17, NULL),
(28, 5, 22, 'Stone', 'cube', '4', '2015-07-28', 16, NULL);
